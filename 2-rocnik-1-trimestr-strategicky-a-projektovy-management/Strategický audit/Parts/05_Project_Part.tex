...
\node [below of = c2, xshift=15pt] (c21) {Rozprodej stávajícího vozového parku};
\node [below of = c21, yshift=-7pt] (c22) {Zavedení příspěvku na hromadnou, sdílenou dopravu};
\node [below of = c22, yshift=-30pt] (c23) {Implementace alternativních způsobů dopravy};
\node [below of = c23, yshift=-35pt] (c24) {Nákup elektro automobilů};
\node [below of = c24, yshift=-20pt] (c25) {Vytvoření malého sdíleného vozového parku};
...
\end{tabularx}
\caption{Is it me you are looking for?}
\label{tab:Hello2}
\end{table}