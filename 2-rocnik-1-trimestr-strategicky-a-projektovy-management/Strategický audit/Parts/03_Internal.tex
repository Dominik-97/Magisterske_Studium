...
\begin{figure}[!hbtp]
	\centering
	\includegraphics[width=0.3\linewidth]{Parts/InternalResources/CHART_Current_assets}
	\caption[Přehled čistého zisku v čase]{Přehled čistého zisku v čase\footnote{Vlastní zpracování vycházející z výkazů zisku a ztrát podniku za období 2010 až 2019.}}
...
\begin{figure}[!hbtp]
	\centering
	\includegraphics[width=0.5\linewidth]{Parts/InternalResources/CHART_Structure_of_assets}
	\caption[Přehled čistého zisku v čase]{Přehled čistého zisku v čase\footnote{Vlastní zpracování vycházející z výkazů zisku a ztrát podniku za období 2010 až 2019.}}
...
\begin{figure}[!hbtp]
	\centering
	\includegraphics[width=0.5\linewidth]{Parts/InternalResources/CHART_Structure_of_liabilities}
	\caption[Přehled čistého zisku v čase]{Přehled čistého zisku v čase\footnote{Vlastní zpracování vycházející z výkazů zisku a ztrát podniku za období 2010 až 2019.}}
