...
\begin{tikzpicture}[node distance=2cm]
	...
	%\coordinate [left of=in1, node distance=2cm] (update) {};
	%\node (cir) [circle, inner sep=0pt, minimum size=1cm, color=white, fill=blue, draw=black, right of=pro1, yshift=0.5cm, xshift=-0.5cm] {A};
	
	%\draw [arrow] (start) -- (in1);
	%\draw [arrow] (start) -| (pro1);
	%\draw [arrow] (start) -- node[right of=in1, xshift=2cm]{} -- (pro1);
	%\draw [arrow] (start) -| node [near start] {} (update) |- (pro1);
	...
	%\draw [arrow] (start) -| node [near start] {} (update) |- (start1);
	%\draw [arrow] (start) -| node [near start] {} (update2) |- (start2);
