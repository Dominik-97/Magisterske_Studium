...
\textbf{V jaké kvalitě (základní parametry) dané opatření musí být zavedeno, aby byl příjemnce benefitu z něho plynoucího spokojen} Kvalitativně dané opatření musí splňovat dvě hlavní kritéria, musí být určité, splnitelné, realizovatelné, mít reálný dopad a u společnosti musí být vidět, že ho dělá, aby si například pomohla i marketingově.
