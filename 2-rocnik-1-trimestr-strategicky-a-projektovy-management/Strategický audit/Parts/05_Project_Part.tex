...
\node [below of = c1, xshift=18pt] (c11) {Setting shape};
\node [below of = c11] (c12) {Výběr dodavatele};
\node [below of = c12, yshift=-4pt] (c13) {Změna dodavatele};
\node [below of = c13, yshift=-12pt] (c14) {Nákup eco-friendly produktů};

\node [below of = c2, xshift=15pt] (c21) {Doprava};
\node [below of = c21, yshift=-7pt] (c22) {Rozprodej stávajícího vozového parku};
\node [below of = c22, yshift=-30pt] (c23) {Zavedení příspěvku na hromadnou, sdílenou dopravu};
\node [below of = c23, yshift=-35pt] (c24) {Implementace alternativních způsobů dopravy};
\node [below of = c24, yshift=-20pt] (c25) {Nákup elektro automobilů};
\node [below of = c25, yshift=-20pt] (c26) {Vytvoření malého sdíleného vozového parku};

\node [below of = c3, xshift=15pt, yshift=-7pt] (c31) {Research dotací};
\node [below of = c31, yshift=-8pt] (c32) {kologická likvidace odpadů};
\node [below of = c32, yshift=-18pt] (c33) {Přizpůsobení nejvyšším enviromentálním standardům};
\node [below of = c33, yshift=-30pt] (c34) {Spotřeba energií z obnovitelných zdrojů};

\node [below of = c4, xshift=15pt] (c41) {Research};
\node [below of = c41] (c42) {Zapojení};

\node [below of = c5, xshift=15pt] (c51) {Definice};
\node [below of = c51] (c52) {Research};
\node [below of = c52] (c52) {Kampaně};
