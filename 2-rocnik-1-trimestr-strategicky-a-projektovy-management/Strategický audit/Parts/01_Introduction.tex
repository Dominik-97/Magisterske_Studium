...
\begin{itemize}
	...
	\item roustoucí požadavky na účetní poradce.
\end{itemize}
...
Jako každá společnost musí i \textit{Proxy a.s.} reagovat na poptávku, pokud chce udržet svojí rentabilitu. Vzhledem k výsledku hospodaření za účetní období (viz graf níže) a vývoj počtu živnostenských oprávnění lze dovodit, že poptávka po účetních službách dlouhodobě stoupá.
