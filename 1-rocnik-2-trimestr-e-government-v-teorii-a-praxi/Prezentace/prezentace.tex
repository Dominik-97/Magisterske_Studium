...
\begin{enumerate}
	...
	\myitem{VYUZITI} Využití datové schránky
...
\begin{itemize}
	\item Pokud vystoupíme ze zákonných definic, tak se ve své podstatě jedná o elektronickou poštovní schránku.
...
\begin{enumerate}
	\item Povinnost datovou schránku vybírat
	\item Potřeba komunikovat s daňovým úřadem prostřednictvím datové schránky\footcite[§72 odstavec 6]{noauthor_2802009_nodate}
	\item Fikce doručení - po 10 dnech se stav zprávy změní na doručené
	\item Pokud není využit datový trezor, zprávy se po 90 dnech mažou\footcite{noauthor_datove_nodate}
\end{enumerate}
